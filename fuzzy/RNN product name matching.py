...
df = pd.read_excel("Sample Data_6.xlsx")
...
# ... Rest of the code remains the same for predictions and DataFrame creation
...
output_file = 'matched_tv_models10.xlsx'
