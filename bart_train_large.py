...
# Initialize BART tokenizer and model (using facebook/bart-large)
...
# Save the trained model (indicate that it's the large model)
model_output_dir = 'C:/Users/Lenovo/Desktop/Web Scraping/bart_large_fixlrre_saved_model'
...
output_file = 'C:/Users/Lenovo/Desktop/Web Scraping/matched_tv_models_large_fixed_lr_reg_7.xlsx'
